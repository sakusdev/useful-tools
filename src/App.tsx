  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.18),_transparent_34rem),#09090b] text-white">
      ...
      <main className="min-h-screen pb-28 lg:ml-80 lg:pb-0">
        <div className="mx-auto max-w-7xl px-4 py-3 sm:p-6 lg:p-10">
          <div className="mb-4 rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-4 backdrop-blur-xl sm:mb-8 sm:rounded-[2rem] sm:p-8">
            ...
            <h2 className="text-2xl font-black tracking-tight sm:text-5xl lg:text-6xl">Modern Utility Toolbox</h2>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-300 sm:mt-4 sm:text-lg sm:leading-7">
